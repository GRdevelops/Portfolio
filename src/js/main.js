	...
	const data = [
		{
			...
			description: `REAI is an <span style='font-weight: 600'>AI-powered tool</span> designed to streamline document review for real estate professionals. It uses advanced AI models to <span style='font-weight: 600'>extract and analyze</span> with high precision information from property documents. It then uses AI engineering techniques to ensure document content remains within the model’s context. At first signup, the tool includes <span style='font-weight: 600'>free credits</span> to fully experience the product before transitioning to a subscription model. With its focus on accuracy and efficiency, REAI significantly <span style='font-weight: 600'>reduces time and errors</span> in property document processing, making it an invaluable asset for both junior and senior real estate agents.`,
